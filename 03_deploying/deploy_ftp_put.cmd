...
::
ECHO %deploy_user%>%temporary_folder%\_deploy_files.txt
ECHO %deploy_pw%>>%temporary_folder%\_deploy_files.txt
...
ECHO put .htaccess>>%temporary_folder%\_deploy_files.txt
ECHO bye>>%temporary_folder%\_deploy_files.txt

:: run the actual FTP commandfile
"%deploy_command%" -s:%temporary_folder%\_deploy_files.txt %deploy_server%
