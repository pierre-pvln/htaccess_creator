...
ECHO "%deploy_command%" -l %deploy_user_downloadserver% -pw %deploy_pw_downloadserver% %extension_folder%\.htaccess %deploy_downloadserver%:%deploy_folder%
PAUSE
"%deploy_command%" -l %deploy_user_downloadserver% -pw %deploy_pw_downloadserver% %extension_folder%\.htaccess %deploy_downloadserver%:%deploy_folder%
