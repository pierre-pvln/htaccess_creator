...
ECHO "%deploy_command%" -l %deploy_user_downloadserver% -pw %deploy_pw_downloadserver% %deploy_downloadserver%:%deploy_folder%\.htaccess %extension_folder%
PAUSE
"%deploy_command%" -l %deploy_user_downloadserver% -pw %deploy_pw_downloadserver% %deploy_downloadserver%:%deploy_folder%\.htaccess %extension_folder%
